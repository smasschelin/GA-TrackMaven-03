...
facebook['media_caption'].fillna('', inplace=True)
facebook['media_title'].fillna('', inplace=True)
facebook['message'].fillna('', inplace=True)
facebook['urls'].fillna('', inplace=True)
facebook['picture_url'].fillna('', inplace=True)
